...
<tbody>
    ...
    <tr>
        ...
        <td>{{$dato->monto}}</td>
        <td>
            <a href="/Retiro/del/{{$dato->id}}/{{$afiliado->id}}/{{$empleado->id}}" class='btn btn-warning'>Eliminar</a>
        </td>
    </tr>
    @else
...
<a href="/Retiro/add/{{$afiliado->id}}/{{$empleado->id}}" class='btn btn-primary'>Hacer Retiro</a>
@endsection